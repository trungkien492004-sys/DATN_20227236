...
OUTPUT_DIR = BASE_DIR.parent / "Output_prompt" / "essay_qwen"      # Prompt/Output_prompt/essay_qwen
...
# ============================================================
# GOM KẾT QUẢ CŨ (quét mọi .csv trong OUTPUT_DIR, không phụ thuộc tên file)
# ============================================================
...
def run_experiment(df_input, prompt_name, prompt_template):
    ...
    done_ids, results = load_prior_results(OUTPUT_DIR, "authid", prompt_name)
